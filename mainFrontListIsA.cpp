...
{
  frontListIsA<string> list;string items[] = {"zero", "one", "two", "three", "four", "five" };
  for (int i = 0; i < 6; i++)
    {
...
void frontListTester(frontListIsA<std::string>* listPtr)
{
  string luke = "Luke";
  string brent = "Brent";
  string donna = "Donna";
  ...
  //remove first entry                                                                              
  cout << "\nRemoving first item (Jerry): " << listPtr->remove() << "; should be 1 (true)" << \
    endl;
